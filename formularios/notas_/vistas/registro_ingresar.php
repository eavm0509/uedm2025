...
$codmat = $_GET['codmat'] ?? '';
$codper = $_GET['codper'] ?? '';
require_once("../../materias_/php/modelo.php");
$obj_temporal= new clase_materias();
$row=$obj_temporal->_consultarcodigo_materi_vista($codmat); 
$fila=$row->fetch();
?>
<!doctype html>
<html lang="es">
...
<body>
  ...
  <div class="container alert alert-info" style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;">
    <h3 class="text-primary mb-4 text-center">Nuevo registro de notas</h3>

    <form action="../php/registro_insertar.php" method="POST">
        <input type="text" name="txt_codper" id="txt_codper" value="<?php echo $codper;?>" hidden>
        <input type="text" name="txt_codmat" id="txt_codmat" value="<?php echo $codmat;?>" hidden> 
    <!-- Fila 1 -->
      <div class="row">
      ...
      <div class="row">
        <!-- Fila 3 columna 1 -->
         <div class="col-6 p-2" style="border-right: 2px solid #ccc;">
            ...
            <input type="checkbox" name="chk_ingnot" id="chk_ingnot" value="1" checked>
