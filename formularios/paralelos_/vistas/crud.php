...
<html lang="es">
    ...
    <body onload="ajax_buscar_paralelos('');">
        <div class="alert alert-light">
            <h2 class="text-primary">Gestión de Paralelos</h2>
            <!--<button type="button" class="btn btn-success" onclick="cargarFormulario()">Nuevo</button>-->
            <button type="button" class="btn btn-success" onclick="abrirModalFormulario()">Nuevo</button>
            <button type="button" class="btn btn-success" onclick="reporte();">Informe</button>
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_paralelos(this.value);">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-header alert alert-info text-primary">
            <h5 class="modal-title" id="modalFormularioLabel">Nuevo Paralelo</h5>
  ...
  <!--   
    <script>
            function cargarFormulario() {
                $("#contenedor_formulario").load("vista_paralelos.html");
            }
    </script>

    
         <script>
        // Función que verifica si el hash es #nuevo y redirige
        function verificarHash() {
            if (location.hash === "#nuevo") {
                window.location.href = "vista_paralelos.html";
            }
        }
        ...
        // Ejecutar cada vez que cambie el hash (cuando haces clic en el botón)
...
<!-- Modal -->
<div class="modal fade" id="elimimar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-danger text-light">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar Registro de paralelos</h1>
