...
<?php
    ...
    if($result)
    {
        echo '<script>jQuery(function(){swal({
            title:"Guardar Area", text:"Registro de area guardado con éxito", type:"success", confirmButtonText:"Aceptar"
        }, function(){location.href="../vistas/index.php?page=movimcsn";});});</script>';
    }
    else
    {
        echo '<script>jQuery(function(){swal({
            title:"Guardar Area", text:"Error al Guardar", type:"danger", confirmButtonText:"Aceptar"
