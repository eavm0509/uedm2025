...
<html lang="en">
    ...
    <body onload="ajax_buscar_areas('');">
        <div class="alert alert-light">
            <h2 class="text-primary">Gestión de Areas</h2>
            <button type="button" class="btn btn-success" onclick="abrirModalFormulario()">Nueva Area</button>
            <button type="button" class="btn btn-success" onclick="reporteG_areas();">Reporte General</button>
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <label class="col-2">AREAS</label>
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_areas(this.value);">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-header alert alert-info text-primary">
            <h5 class="modal-title" id="modalFormularioLabel">Nueva Area</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-danger text-light">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar registro de area</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="../php/eliminar_areas.php" method="post">
