...
<html lang="es">
    ...
    <body onload="ajax_buscar_secciones('');">
        <div class="alert alert-light">
            <h2 class="text-primary">Gestion de Secciones</h2>
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_secciones(this.value);">
