...
<html lang="es">
    ...
    <body onload="ajax_buscar_cursos('');">
        <div class="alert alert-light">
            <h2 class="text-primary">Gestión de Cursos o Años</h2>
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_cursos(this.value);">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-header alert alert-info text-primary">
            <h5 class="modal-title" id="modalFormularioLabel">Nuevo Curso</h5>
