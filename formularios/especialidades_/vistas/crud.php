...
<html lang="es">
    ...
    <body onload="ajax_buscar_especialidades('');">
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <label class="col-2">Especialidades</label>
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_especialidades(this.value);">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-header alert alert-info text-primary">
            <h5 class="modal-title" id="modalFormularioLabel">Nueva Especialidad</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="../php/eli_espe.php" method="post">
