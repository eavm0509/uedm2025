...
<html lang="en">
    ...
    <body onload="ajax_buscar_fcursos('');">
        <div class="alert alert-light">
            <h2 class="text-primary">Gestión de Años o Cursos</h2>
        ...
        <div class="container alert alert-info col-5">
            <h3>Buscar</h3>
            <div class="row">
                <input type="text" class="form-control col-4" id="txt_buscar" name="txt_buscar" onkeyup="ajax_buscar_fcursos(this.value);">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-danger text-light">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar registro de cursos formados</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="../php/eli_fcursos.php" method="post">
                
                <div class="container">
                    <div class="row">
                        <label><b>ID  : </b></label>
                        <input type="text" id="txt_codigo" name="txt_codigo" class="form-control" readonly>
                    </div>


                    <div class="row">
                        <label><b>Descripcion  : </b></label>
                        <input type="text" id="txt_descripcion" name="txt_descricion" class="form-control" disabled>
                    </div>
                    <div class="row">
                        <label><b>Tutor : </b></label>
                        <input type="text" id="txt_profesor" name="txt_profesor" class="form-control" disabled>
                    </div>
                    <div class="row mt-2">
