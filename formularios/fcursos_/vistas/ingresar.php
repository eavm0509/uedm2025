...
<body>
    <div class="container alert alert-info" style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;" >
        <h2 class="text-primary mb-4 text-center">Nuevo Curso</h2>
        <form action="../php/controlador_insertar.php" method="post">
          ...
          <div class="row">
                ...
                <select name="cmb_curso" id="cmb_curso" class="form-select" required></select>
                </div>

                <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                    <label for="cmb_ciclo" class="form-label">Ciclo/educación:</label>
                <select name="cmb_ciclo" id="cmb_ciclo" class="form-select" required></select>
                </div>

                <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                    <label for="cmb_seccion" class="form-label">Sección:</label>
                <select name="cmb_seccion" id="cmb_seccion" class="form-select" required></select>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                ...
                <select name="cmb_paralelo" id="cmb_paralelo" class="form-select" required></select>
            </div>
          ...
          <div class="row">
                <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                    ...
                    id="txt_orden"  style="text-align: right;" onkeydown="return evitarEnter(event);"
                    value=0>
                    
                    
                    <label for="txt_descri" > <b>Descripción</b></label>
                    <input type="text"   class="form-control col-4" name="txt_descri" 
                           id="txt_descri" oninput="this.value = this.value.toUpperCase();"
                           maxlength="20" required onkeydown="return evitarEnter(event);">
                    <br>
                    <input type="hidden" name="txt_jurban" value=0>
                    <label for="txt_jurban" > <b>Juran bandera</b></label>
                    <input type="checkbox" value=1 name="txt_jurban" id="txt_jurban"><br>
                </div>
                ...
                <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                    ...
                    <input type="radio" name="rb_tipcon" id="rb_tipcon" value="1" checked></input><br>

                    <label> EGBS O BACHILLERATO</label> 
                    <input type="radio" name="rb_tipcon" id="rb_tipcon" value="2"></input><br>

                    <label> INICIAL Y PREPARATORIA</label> 
                    <input type="radio" name="rb_tipcon" id="rb_tipcon" value="3"></input><br>

                    <label> EGB 2-3</label> 
                    <input type="radio" name="rb_tipcon" id="rb_tipcon" value="4"></input><br>

                    <label> EGB 4</label> 
                    <input type="radio" name="rb_tipcon" id="rb_tipcon" value="5"></input><br>
                ...
                <div class="col-4 p-3" style="border-right: 2px solid #ccc;">
                    ...
                    step="any" style="text-align: right;" onkeydown="return evitarEnter(event);"
                    value=0.00 >
                    ...
                    style="text-align: right;" onkeydown="return evitarEnter(event);"
                    value=0>
